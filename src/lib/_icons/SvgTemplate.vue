<template>
  <svg>
    ...
    <symbol id="tu-icon-code-slash" viewBox="0 0 512 512">
      <path
    ...
    <symbol id="tu-icon-code" viewBox="0 0 512 512">
      <path
        d="M160 389a20.91 20.91 0 0 1-13.82-5.2l-128-112a21 21 0 0 1 0-31.6l128-112a21 21 0 0 1 27.66 31.61L63.89 256l109.94 96.19A21 21 0 0 1 160 389z"
      ></path>
      <path
    ...
    <symbol id="tu-icon-error" viewBox="0 0 512 512">
      <path
    ...
    <symbol id="tu-icon-github" viewBox="0 0 512 512">
      <path
    ...
    <symbol id="tu-icon-help" viewBox="0 0 512 512">
      <path
    ...
    <symbol id="tu-icon-info" viewBox="0 0 512 512">
      <path
    ...
    <symbol id="tu-icon-success" viewBox="0 0 512 512">
      <path
    ...
    <symbol id="tu-icon-warning" viewBox="0 0 512 512">
      <path
